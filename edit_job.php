				...
				<input type="hidden" name="specialize" id="advance_edit" class="form" value="<?=$resjob['keyskill'];?>"/>																</td>
												...
												<tr>
													...
													<select class="textbox" style="float: left;" name="job_type">
														...
														<option value="permanent"<?php if($resjob['job_type']=="permanent"){echo "selected";}?>>Permanent</option>
														<option value="Temporary/Contract" <?php if($resjob['job_type']=="Temporary/Contract"){echo "selected";}?>>Temporary/Contract</option>
														<option value="Contract" <?php if($resjob['job_type']=="Contract"){echo "selected";}?>>Contract</option>
													</select>
													</td>
												</tr>
												<td>&nbsp;</td>
