...
$res=mysql_query("select * from `user_detail` where `emailid`='$user' and `password`='$pwd' and `is_employer`='0'");
$no=mysql_num_rows($res);
if($no>0){
 $fetch=mysql_fetch_array($res);
 if($fetch['status']==1)
 {
  $_SESSION['useridval']=$fetch['slno'];
  $_SESSION['userid']=$user;
  $_SESSION['userpass']=$pwd;
  $_SESSION['employee_name']=$fetch['first_name'].' '.$fetch['last_name'];
        		 ...
        		 <div id="w">	
                        <div id="page" style="padding-bottom:20px;">
                          <div id="content-login">
                            <h2 style="margin-top:0px;">Login to the Site</h2>
                            <div class="content">
							<?php
							if(isset($_GET['mess']))
							{
							...
							if(isset($_GET['msg']))
							{
							    echo "<h3 style='color:red;'>".$_GET['msg']."</span></h3>";
							}
							?>
                            ...
                            <table style="width:100%; font-size:15px; font-weight:bold; line-height:2.5;">
                            		<tr>
                                     ...
                                     <tr>
                                     		<td> <input type="password" name="password" id="password" class="textbox" tabindex="2" autocomplete="off" required onblur="return valid($('#password').val());"></td>
                                     </tr>
                                      <tr>
                          ...
                          <div id="content-register">
                            <h2>Register a New Account</h2>
								...
								<form  name="registerform" action="insert_register.php" method="post" onsubmit="return validate();">
                            <div class="content">
