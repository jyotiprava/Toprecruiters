...
if($newimage=='')
{
mysql_query("update `alljob` set `postname`='$postname',`noofvaccancy`='$noofpost',`shortdesc`='$shortdesc',`keyskill`='$specialize',`desc`='$desc',`range1`='$range1',`range2`='$range2',`experience`='$experience',`location`='$location',`industry`='$industry',`jobfunction`='$jobfunction',`job_type`='$job_type' where `id`='$id'");
...
mysql_query("update `alljob` set `postname`='$postname',`noofvaccancy`='$noofpost',`shortdesc`='$shortdesc',`keyskill`='$specialize',`desc`='$desc',`range1`='$range1',`range2`='$range2',`experience`='$experience',`location`='$location',`industry`='$industry',`jobfunction`='$jobfunction',`logo`='$filename1',`job_type`='$job_type' where `id`='$id'");
$msg="successfully updated";
}
