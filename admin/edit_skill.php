				...
				<div id="right_box" >
						...
						<div id="content1">
								...
								<div id="content2" style="min-height:350px;">
									...
									?>
										<form name="myform" method="post" action="update_skill.php">
											<table class="table" style="height:250px; line-height:1.5;">
												<?php
												$fetch=mysql_query("select * from `skill` where `slno`='$id'");
												$res=mysql_fetch_array($fetch);
												?>
												<tr>
												<td align="center">Skill Name</td>
												<td><input type="text" name="skill" class="form" required value="<?php echo $res['skill'];?>" />
