				...
				<div id="right_box" >
						...
						<div id="content1">
								...
								<div id="content2" style="min-height:350px;">
									...
									?>
										<form name="myform" method="post" action="edit_jobfunctionres.php">
											<table class="table" style="height:250px; line-height:1.5;">
												<?php
												$fetch=mysql_query("select * from `job_function` where `slno`='$id'");
												...
												{
												?>
												<option value="<?php echo $result['slno'];?>"<?php 
												if($result['slno']==$res['industry_id'])
												{
												echo "selected";
												}
												?>><?php echo $result['industry'];?></option>
												<?php
												}
												?>
												</select>
												...
												<td><input type="text" name="jobfunction" class="form" required value="<?php echo $res['jobfunction'];?>" />
