...
//is_admin();
$id=$_GET['id'];
$qwe=mysql_query("select * from `bottomimage` where `slno`='$id'")or die(mysql_error());
				...
				<div id="right_box" >
						...
						<div id="content1">
								...
								<div id="content2" style="min-height:350px;">
										...
										<form name="myform" method="post" action="update_banner1.php" enctype="multipart/form-data">
