				...
				<div id="right_box" >
						...
						<div id="content1">
								...
								<div id="content2" style="min-height:350px;">
										...
										<form name="myform" method="post" action="qualification_insert.php">
										  ...
										  echo "<span style='font-family:arial; color:#5FBE5F; margin-left:20px;'>".$mess."</span>";
											...
											?>
												...
												<td><input type="text" name="qualification" class="form" required ></td>
												</tr>
											...
											<tr>
                                                                                        ...
                                                                                        <?php
                                                                                        $que=mysql_query("select *from `qualification`");
                                                                                        ...
                                                                                        <td><a href="qualification_edit.php?id=<?php echo $res['id']; ?>"><img src="images/edit.png" width="60"></a></td>
