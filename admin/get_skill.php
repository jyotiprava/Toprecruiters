...
echo $pagination;
			if($total_pages==0)
					 ...
					 ?>
						<span style="float: left; margin-left: 10px;color: #a60006;cursor: pointer;border-bottom: 1px solid #a60006;" onclick="return removeshort(<?php echo $reskeyskill['slno']; ?>);" id="remvid<?php echo $reskeyskill['slno']; ?>">Remove from Shortlist</span>
					<?php
					 }
					?>
					</div>
...
echo 	$getyear;		
						...
						?>
						<input type='hidden' name='hid' id='hid_slno' value='<?php echo $contslno; ?>' />
						</div>
						<?php
						}
						?>