				...
				<div id="right_box" >
						...
						<div id="content1">
								...
								<div id="content2" style="min-height:350px;">
									...
									?>
										<form name="myform" method="post" action="update_language.php">
											<table class="table" style="height:250px; line-height:1.5;">
												<?php
												$fetch=mysql_query("select * from `language` where `slno`='$id'");
												$result=mysql_fetch_array($fetch);
												?>
												<tr>
												<td align="center">Language</td>
												<td><input type="text" name="language" class="form" required value="<?php echo $result['language'];?>" />
												<input type="hidden" name="hid" value="<?php echo $result['slno']; ?>" />
												</td>
												</tr>
