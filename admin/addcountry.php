...
<script type="text/javascript">
		function delete_data(vals){
			...
			if(con){
			window.location="delete_country.php?id="+vals;
			}
		}
</script>
</head>
				...
				<div id="right_box" >
						...
						<div id="content1">
								...
								<div id="content2" style="min-height:350px;">
										...
										<form name="myform" method="post" action="insert_country.php">
										  ...
										  echo "<span style='font-family:arial; color:#5FBE5F; margin-left:20px;'>".$mess."</span>";
											...
											?>
												...
												<td><input type="text" name="country" class="form" required ></td>
												</tr>
											        <tr>
												<td align="center">Country Code</td>
												<td><input type="text" name="countrycode" class="form" required ></td>
												</tr>
												<tr>
												<td>&nbsp;</td>
												<td>
					...
					<div style="width: 97%;height: 400px;float: left;overflow: auto;">
						...
						<td>													
												<?php echo $res['countrycode'];?>
                                    		</td>
                                            <td><a href="edit_country.php?id=<?php echo $res['slno']; ?>"><img src="images/edit.png" width="60"></a></td>
