				...
				<div id="right_box" >
						...
						<div id="content1">
								...
								<div id="content2" style="min-height:350px;">
									...
									?>
										<form name="myform"  action="update_position_level.php" method="post">
											<table class="table" style="height:250px; line-height:1.5;">
												<?php
												$fetch=mysql_query("select * from `position_level` where `slno`='$id'");
												$res=mysql_fetch_array($fetch);
												?>
												<tr>
												<td>Position Level</td>
												<td><input type="text" name="position" class="form" required value="<?php echo $res['position'];?>">
