...
function setupTinyMCE() {
  $('textarea.tinymce').tinymce({
        ...
        script_url: 'http://23.253.22.203/job/admin/js/tiny-mce/tiny_mce.js',
		mode: 'textarea',
        // General options
        theme: "advanced",
        plugins: "autolink,lists,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,advlist,fullpage",
