...
<script type="text/javascript">
		function delete_data(vals){
			...
			if(con){
			window.location="delete_citizen.php?id="+vals;
			}
		}
</script>
</head>
				...
				<div id="right_box" >
						...
						<div id="content1">
								...
								<div id="content2" style="min-height:350px;">
										...
										<form name="myform" method="post" action="insert_citizen.php">
										  ...
										  echo "<span style='font-family:arial; color:#5FBE5F; margin-left:20px;'>".$mess."</span>";
											...
											?>
												...
												<td><input type="text" name="citizen" class="form" required ></td>
												</tr>
											...
											<?php
															$que=mysql_query("select *from citizenship");
															while($res=mysql_fetch_array($que))
															{
											?>																					
                                    		<tr>
                                    		<td>													
												<?php echo $res['citizen'];?>
                                    		</td>
                                            <td><a href="edit_citizen.php?id=<?php echo $res['slno']; ?>"><img src="images/edit.png" width="60"></a></td>
