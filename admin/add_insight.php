...
<script type="text/javascript">
		function delete_data(vals){
			...
			if(con){
			window.location="delete_insight.php?id="+vals;
			}
		}
</script>
<!-- Load TinyMCE-->
				...
				<div id="right_box" >
						...
						<div id="content1">
								...
								<div id="content2" style="min-height:350px;">
										...
										<form name="myform" method="post" action="insert_insight.php" enctype="multipart/form-data">
										  ...
										  echo "<span style='font-family:arial; color:#5FBE5F; margin-left:20px;'>".$mess."</span>";
											...
											?>
												<tr>
												<td align="center">Insight Image</td>
												<td><input type="file" name="inimg"  ><br/>
												...
												<tr>
												<td align="center">Insight Heading</td>
												<td><textarea name="heading" class="form" required style="height: 50px;"></textarea></td>
												</tr>
                                                                                                <tr>
                                                                                                    <td>&nbsp;</td>
                                                                                                </tr>
												<tr>
												<td align="center">Insight Description</td>
					    ...
					    <table class="table1">
					    <tr>
                                    		<th>Insight Images</th>
                                                <th>Insight Heading</th>
                                                <th colspan="2">Action</th>
                                    	    </tr>
						    <?php
							$que=mysql_query("select * from `insight`");
						    ...
						    ?>																					
                                    	    <tr>
                                                ...
                                                <td><a href="edit_insight.php?id=<?php echo $res['slno']; ?>"><img src="images/edit.png" width="60"></a></td>
