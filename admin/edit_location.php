...
is_admin();
$locid=$_GET['id'];
$sqlarea=mysql_query("select * from `location` where `slno`='$locid'");
$resarea=mysql_fetch_array($sqlarea);
?>
<html>
<head>
				...
				<div id="right_box" >
						...
						<div id="content1">
								...
								<div id="content2" style="min-height:350px;">
									...
									?>
										<form name="myform"  action="update_location.php" method="post">
											<table class="table" style="height:250px; line-height:1.5;">
												
												<tr>
												<td>Name Of Location</td>
												<td><input type="text" name="locname" class="form" value="<?php echo $resarea['location'];?>">
												<input type="hidden" name="hidden_id" value="<?php echo $resarea['slno'];?>" />
												</td>
												</tr>
												<tr>
												<td>&nbsp;</td>
