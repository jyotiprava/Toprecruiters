...
if($nimage=='')
{
 $qwe=mysql_query("update `bannerimage` set `title`='$title' where `slno`='$id' ")or die(mysql_error());
...
$qwe=mysql_query("update `bannerimage` set `bannerimage` = '$filename',`title`='$title' where `slno`='$id'")or die(mysql_error());
$msg="Updated successfully.";
}
}
