				...
				<div id="right_box" >
						...
						<div id="content1">
								...
								<div id="content2" style="min-height:350px;">
										...
										<form name="myform" method="post" action="insert_indexcontent.php" enctype="multipart/form-data">
										  ...
										  echo "<span style='font-family:arial; color:#5FBE5F; margin-left:20px;'>".$mess."</span>";
											...
											<tr>
												...
												?>
												<td><textarea name="indexheading" class="form tinymce" style="height: 80px;">
												<?php if($result==1){
															echo $res['heading'];
										                }
												else{ echo "";	}
						...
						<?php
                                                $add=mysql_query("select * from `page`")or die(mysql_error());
						...
						<?php echo $res['content']; ?>						
                                            ...
                                            <td><a href="edit_indexcontent.php?id=<?php echo $res['slno']; ?>"><img src="images/edit.png" width="60"></a></td>
