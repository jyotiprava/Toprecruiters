...
//is_admin();
$id=$_GET['id'];
$qwe=mysql_query("select * from `insight` where `slno`='$id'")or die(mysql_error());
				...
				<div id="right_box" >
						...
						<div id="content1">
								...
								<div id="content2" style="min-height:350px;">
										...
										<form name="myform" method="post" action="update_insight.php" enctype="multipart/form-data">
										...
										?>
												...
												<td>
										                      <textarea name="heading" class="form" required style="height: 50px;"><?php echo $res['heading'];?></textarea>
												</td>
												</tr>
												<tr>
												<td align="center">Insight Description</td>
												<td><textarea name="descp" class="tinymce" style="height: 50px;"><?php echo $res['description'];?></textarea></td>
												</tr>
												<tr>
												<tr>
												<td>&nbsp;</td>
