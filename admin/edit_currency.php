...
$id=$_GET['id'];
$fetch=mysql_query("select * from `currency` where `slno`='$id'");
				...
				<div id="right_box" >
						...
						<div id="content1">
								...
								<div id="content2" style="min-height:350px;">
									...
									?>
										<form name="myform" method="post" action="update_currency.php">
											<table class="table" style="height:250px; line-height:1.5;">
												<tr>
												<td align="center">Currency</td>
												<td><input type="text" name="currency" class="form" required value="<?php echo $res['symbol'];?>" />
