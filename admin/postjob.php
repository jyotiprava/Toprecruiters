...
<script type="text/javascript">
		function delete_data(vals){
			...
			if(con){
			window.location="deletejob.php?id1="+vals;
			}
		}
...
<div id="content2_bar">
		<div id="content2_box">
        		<div id="content2_left">
                		...
                		<div id="content2_leftbox" style="width:750px;height:auto; margin-left: 10px;" >
				 <?php
				       if(isset($_GET['msg']))
										  {
										  $mess=$_GET['msg'];
									...
									?>
			      <form name="myform"  action="jobinsert.php" method="post" enctype="multipart/form-data">
				...
				<div style="width: 960px;height: auto; float: left;margin-top: 20px; " >
				 <table class="table1" cellpadding="5" style="width: 1010px;height:auto;" border="1">
						...
						<th colspan="4" bgcolor="#FF0000">Action</th>
												...
												$i=0;
                                                                                                //$user_id=0;
											$add=mysql_query("select * from `alljob`")or die(mysql_error());
											while($result=mysql_fetch_array($add)){
											$loc=$result['location'];
											$sqlloc=mysql_query("select * from `location` where `slno`='$loc'") or die(mysql_error());
				...
				$totalapp=mysql_num_rows($qapplication);
                                            ...
                                            <tr>
												...
												<td><?=$totalapp;?></td>
												<td><a href="viewpost.php?id=<?php echo $result['id'];?>" target="_blank">View Application</a></td>
												<td><a href="editjob.php?id=<?php echo $result['id'];?>"><img src="images/edit.png" ></a></td>
