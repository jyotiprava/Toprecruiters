...
//is_admin();
$id=$_GET['id'];
$qwe=mysql_query("select * from `admin_testimonial` where `slno`='$id'")or die(mysql_error());
				...
				<div id="right_box" >
						...
						<div id="content1">
								...
								<div id="content2" style="min-height:350px;">
										...
										<form name="myform" method="post" action="update_testimonial.php" enctype="multipart/form-data">
										...
										?>
												...
												<td>
                                                                                                    <input type="text" name="pname" class="form" required  value="<?php echo $res['personal_name'];?>">
												...
												<td><input type="text" name="cname" class="form" required value="<?php echo $res['company_name'];?>"></td>
												</tr>
                                                                                                <tr>
                                                                                                    <td>&nbsp;</td>
                                                                                                </tr>
												...
												<td><input type="text" name="desig" class="form" required value="<?php echo $res['designation'];?>"></td>
												</tr>
                                                                                                <tr>
                                                                                                    <td>&nbsp;</td>
                                                                                                </tr>
												...
												<td align="center">Short Description</td>
                                                                                                <td><textarea name="sdesc" class="tinymce" style="height: 50px;"><?php echo $res['short_description'];?></textarea></td>												
												</tr>                                                                                                
												<tr>
												<td>&nbsp;</td>
												<td>
