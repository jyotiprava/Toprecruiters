				...
				<div id="right_box" >
						...
						<div id="content1">
								...
								<div id="content2" style="min-height:350px;">
									...
									?>
										<form name="myform" method="post" action="update_country.php">
											<table class="table" style="height:250px; line-height:1.5;">
												<?php
												$fetch=mysql_query("select * from `country` where `slno`='$id'");
												$res=mysql_fetch_array($fetch);
												?>
												<tr>
												<td align="center">Country</td>
												<td><input type="text" name="country" class="form" required value="<?php echo $res['country'];?>" />
												<input type="hidden" name="hid" value="<?php echo $res['slno']; ?>" />
												</td>
												</tr>
												<tr>
												<td align="center">Country Code</td>
												<td><input type="text" name="countrycode" class="form" required value="<?php echo $res['countrycode'];?>"></td>
												</tr>			
												<tr>
												<td>&nbsp;</td>
												<td>
