...
.cvheading:before {
  ...
  padding-right: 5px;
	...
	<script type="text/javascript" src="js/jquery-1.10.2.min.js"></script><!-- Skitter Styles -->
...
<div class="left_menuhead2"><img src="images/image.png" style="float:left; margin-right:15px;" /> <a href="index1.php" style="color:#fff; text-decoration:none; margin-top:2px;">Sign Up for Jobs </a> <img src="images/list3.png" style="float:right; margin-top:3px;" /></div>

<div class="left_menuhead" style="margin-top: 10px; font-size:18px;">Specialist Recruitment Services</div>
...
<ul>
	...
	<!-- <li><i><img src="images/listicon1.png" width="13"/></i> <a href="#">Page Executive</a></li>
                                                <li><i><img src="images/listicon1.png" width="13"/></i> <a href="#">Page Group</a></li>
                                                <li><i><img src="images/listicon1.png" width="13"/></i> <a href="#">Investors</a></li>-->
</ul>
</div>
</div>

<div class="left_menu1" style="margin-top:5px;">
<div class="left_menuhead2"><img src="images/edit.png" style="float:left; margin-top:3px; margin-right:15px;" /> <a href="http://myjobstreet.jobstreet.com/career-enhancer/basic-salary-report.php" style="color:#fff; text-decoration:none;"> Average Salary Report 2014 </a> <img src="images/list3.png" style="float:right; margin-top:3px;" /></div>
</div>
</div>
...
<div style="width:410px; height:auto; float:left; margin-left:50px;">
<p class="text2" style="margin-top:10px; color:#5c5c5c;"><span class="head10">Join as Recruitment Consultant!</span><br />
<br />
Join us as a Recruitment Consultant or Senior Consultant and earn a minimum income of $5,000 up to 5 digits every month! This is achievable thanks to our commission scheme of up to 20%, which is one of the highest in the industry.<br />
<br />
<span class="head10" style="text-decoration:none;">Responsibilities:</span></p>

<div class="text2" style="margin-left:25px; color:#6b6b6b;">-Identifying new business opportunities and ensuring repeat assignments from current clients<br />
-Understanding clients' business and identifying their recruitment needs<br />
-Short-listing, interviewing and selecting the right candidates according to clients' requirements<br />
-Managing clients' and candidates' expectations<br />
-Providing good customer service and building rapport with clients and candidates</div>
<br />
<br />
<span class="head10" style="text-decoration:none;">Requirement:</span>

<div class="text2" style="margin-left:25px; color:#6b6b6b;">-Diploma holder<br />
- Self -motivated, target-oriented and sales-focused, with good follow-up skills<br />
- Ability to achieve sales target as assigned by the company<br />
- Possess high energy level and enloy working in a fast-paced environment<br />
- Possess initiative with a positive attitude<br />
- Able to work independently and as a team player<br />
- Good communication and interpersonal skills<br />
-Fresh graduates from polytechnics and universities are welcome to apply<br />
<br />
Email Us if you are interested.<br />
 </div>
<!--<span class="head10">Payroll Administration</span>
								</br>
								</br>
								Pioneered the concept of temporary staffing services. Internationally, we now provide temporary services for nearly 700,000 employees every year. Once seen as simply a means to replace a staff members' absence from the workplace, changes over recent decades have changed the profile of the traditional workforce. We back all of its temÂ¬porary employees by a 100% guarantee - and we stand by it.
								<br/>--></div>

<div style="width:465px; height:auto; float:left;">
<p class="text2" style="margin-top:10px; color:#5c5c5c;"><span class="head10">Be a Team Manager! </span><br />
<br />
<span class="head10" style="text-decoration:none;">Are You Born To Lead?</span><br />
<br />
Join us as a Team Manager (Recruitment) and earn a 5 -digit monthly income with Overriding Commission of up to 15%*!<br />
<br />
As a Team Manager, you will lead and manage a team of Recruitment Consultants and moti-vate thern towards meeting the team sales target. Strong leadership and people management skills are essential in this role.<br />
<br />
<span class="head10" style="text-decoration:none;">Requirements:</span></p>

<div class="text2" style="margin-left:25px; color:#6b6b6b;">-Diploma/Degree holder<br />
- Minimum 3 years' experience in the recruitment Industry or at least 3 years' sales experience at managerial level<br />
- Experience in managing a sales team<br />
- Strong motivator and result-driven person<br />
- Good track record of success in sales<br />
-Able to plan and strategise to ensure the team hits its monthly, quarterly and annual targets<br />
-Possess excellent communication and interpersonal skills<br />
 </div>
</div>

<p class="text2" style="margin-top:10px; color:#5c5c5c;"><br />
<br />
If you have what it takes to lead a dynamic team, we would like to hear from you.<br />
The remuneration package will commensurate with the qualifications and experience of the successful candidate.<br />
<br />
<span style="color:#a81b1b;">Email Us </span> if you are interested.<br />
<br />
We regret only short listed candidates will be notified.<br />
<br />
...
<div id="testimonials">Testimonials <img src="images/icon1.png" width="15" /></div>
...
<div class="right_textbox2" style="display:none;"><?php
						 ...
						 ?>
<div class="right_img"><img src="admin/<?php echo $reslogo['logo'];?>" /></div>
<?php
						}
						?></div>
</div>
