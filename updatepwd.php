...
if(isset($_POST['Submit']))
{
	...
	{
	$status="<span style='margin-top:0px; color:red; font-size:14px; margin-left:20px;'>Re-type Password Cannot Be Blank.</span>";
	
	}
	else
	{
	$newpwd=md5(htmlentities($_POST['newpwd'],ENT_QUOTES));
	$que=mysql_query("UPDATE `user_detail` SET `password`='$newpwd' WHERE `emailid`='$email' and `is_employer`='0'");
    	if($que)
	{
        		 ...
        		 <div id="w">	
                        <div id="page" style="padding-bottom:20px;">
                          <div id="content-login">
                            ...
                            <div class="content">
							<?php echo  $status;?>
                              <form id="login" name="login" action="#" method="post" onsubmit="return validate();">
								<table style="width:100%; font-size:15px; font-weight:bold; line-height:2.5;">
				
   
<tr>
<td>Emailid</td>
<td><input type="text" name="username" value="<?php echo $email;?>" class="textbox" readonly/></td>
</tr> 
  <tr>
    <td>New Password </td>
    <td><input type="password" name="newpwd" class="textbox" id="newpwd" required onblur="return valid($('#newpwd').val());"/></td>
  </tr>
  <tr>
    <td>Retype Password </td> 
    <td><input type="password" name="repwd" class="textbox" id="repwd" required onblur="return valid($('#repwd').val());"/></td>
  </tr>  
  <tr> 
  	<td>&nbsp;</td>
